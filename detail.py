...
class Detail:
    ...
    def init_ui_default_values(self):
        ...
        self.ui.lineEdit_adBx.setText('20.000')
        self.ui.lineEdit_adBy.setText('20.000')
        self.ui.lineEdit_adBz.setText('20.000')
        self.ui.lineEdit_adBRr.setText('20.000')
        self.ui.lineEdit_adBRp.setText('20.000')
        self.ui.lineEdit_adBRy.setText('20.000')
