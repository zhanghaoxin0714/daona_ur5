...
class Detail:
    ...
    def init_ui_default_values(self):
        ...
        self.ui.lineEdit_adMx.setText('0.350')
        self.ui.lineEdit_adMy.setText('0.350')
        self.ui.lineEdit_adMz.setText('0.320')
        self.ui.lineEdit_adMRr.setText('0.018')
        self.ui.lineEdit_adMRp.setText('0.018')
        self.ui.lineEdit_adMRy.setText('0.01')

        # ==================== UI默认值设置 - 导纳参数B矩阵 ====================
        # B矩阵参数 (20, 20, 20, 20, 20, 20)
        self.ui.lineEdit_adBx.setText('120.000')
        self.ui.lineEdit_adBy.setText('120.000')
        self.ui.lineEdit_adBz.setText('150.000')
        ...
        self.ui.lineEdit_adKx.setText('50.000')
        self.ui.lineEdit_adKy.setText('50.000')
