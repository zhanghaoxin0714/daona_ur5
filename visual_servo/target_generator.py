...
def generate_target_points_auto_scale(current_corners, current_tvec, target_distance, image_resolution):
    ...
    """
    current_distance = np.linalg.norm(current_tvec)#计算当前的距离
    # 当前包围框的宽度和高度
    ...
    scale = current_distance / target_distance  # 距离越远，图像越小；越近越大  计算缩放比例
    #print("current_distance: ",current_distance)
    #print("target_distance: ",target_distance)
    #print("scale: ",scale)
    expected_width = current_width * scale #计算目标距离下的期望尺寸
